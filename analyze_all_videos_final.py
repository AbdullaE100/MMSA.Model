#!/usr/bin/env python3
"""
Script to analyze all test videos using our final improved analyzer.
"""
...
def main():
    ...
    # Output file
    output_file = 'final_analysis_results.txt'
    with open(output_file, 'w') as f:
        f.write("Final Video Emotion Analysis Results\n")
        f.write("=================================\n\n")
    ...
    for video_path in video_paths:
        ...
        try:
            result = subprocess.run(
                [sys.executable, 'improved_emotion_analyzer_final.py', video_name],
                capture_output=True,
                text=True,
                check=True
            )
