#!/usr/bin/env python3
"""
Quick check script that only shows SUCCESS or FAILURE without detailed output
"""
...
def main():
    try:
        ...
        if accuracy == 100:
            ...
            print(f"FAILURE: {correct_count}/{total_count} videos ({accuracy:.1f}%) classified correctly")
            # List incorrect classifications in a simple format
